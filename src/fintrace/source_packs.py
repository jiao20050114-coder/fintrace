    ...
    "fund-manager": SourcePack(
        ...
        registry={
            ...
            "source_template": {
                ...
                "support_terms": ["AUM increased", "positive performance", "inflows"],
                "counter_terms": ["outflows", "drawdown", "regulatory risk", "key person"],
                "finance_terms": ["AUM", "performance", "subscriptions", "redemptions", "fund"],
            },
        },
    ),
}
